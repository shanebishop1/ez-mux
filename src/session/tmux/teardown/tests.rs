...
impl TeardownExecutor for FakeTeardownExecutor {
    fn tmux_output(&self, args: &[&str]) -> Result<CommandOutput, crate::session::SessionError> {
    ...
    fn terminate_process(&self, pid: u32) -> Result<CommandOutput, crate::session::SessionError> {
